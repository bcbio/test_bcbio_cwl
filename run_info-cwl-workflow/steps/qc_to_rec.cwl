...
- default: multi-combined
  ...
  inputBinding:
    ...
    separate: false
  type: string
- default: qc_rec:description;reference__fasta__base;config__algorithm__coverage_interval;genome_build;config__algorithm__coverage;config__algorithm__tools_off;config__algorithm__qc;analysis;config__algorithm__tools_on;config__algorithm__variant_regions;align_bam;config__algorithm__variant_regions_merged;config__algorithm__coverage_merged
  id: sentinel_outputs
  inputBinding:
    itemSeparator: ;;
    position: 1
