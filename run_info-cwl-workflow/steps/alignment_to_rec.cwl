...
- default: multi-combined
  ...
  inputBinding:
    ...
    separate: false
  type: string
- default: alignment_rec:description;config__algorithm__align_split_size;reference__fasta__base;rgnames__lb;rgnames__rg;rgnames__lane;reference__bwa__indexes;files;config__algorithm__aligner;rgnames__pl;rgnames__pu;config__algorithm__mark_duplicates;rgnames__sample;reference__snap__indexes
  id: sentinel_outputs
  inputBinding:
    itemSeparator: ;;
    position: 1
