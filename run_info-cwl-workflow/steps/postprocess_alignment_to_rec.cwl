...
- default: multi-combined
  ...
  inputBinding:
    ...
    separate: false
  type: string
- default: postprocess_alignment_rec:description;reference__fasta__base;config__algorithm__coverage_interval;config__algorithm__recalibrate;config__algorithm__coverage;config__algorithm__variant_regions;align_bam;config__algorithm__variant_regions_merged;config__algorithm__variant_regions_orig;config__algorithm__coverage_merged;config__algorithm__coverage_orig;config__algorithm__seq2c_bed_ready
  id: sentinel_outputs
  inputBinding:
    itemSeparator: ;;
    position: 1
