    ...
    scatter (prep_samples_rec_local in prep_samples_to_rec.prep_samples_rec) {
      ...
      call prep_samples {
          input: description=prep_samples_rec_local.description, 
            ...
            config__algorithm__coverage=prep_samples_rec_local.config__algorithm__coverage, 
            config__algorithm__variant_regions=prep_samples_rec_local.config__algorithm__variant_regions
      }
...
task prep_samples_to_rec {
    ...
    command {
        ...
        sentinel-parallel=${default='multi-batch' sentinel-parallel} \
        sentinel-outputs=${default='prep_samples_rec' sentinel-outputs} \
        config__algorithm__coverage=${sep=';;' config__algorithm__coverage} \
        config__algorithm__variant_regions=${sep=';;' config__algorithm__variant_regions} \
        reference__fasta__base=${sep=';;' reference__fasta__base} \
        description=${sep=';;' description}
    ...
    output {
        Array[Object] prep_samples_rec = read_cwl_json('cwl.output.json', 'prep_samples_rec')
    }
