...
workflow main_run_info_cwl {
    ...
    Array[String] config__algorithm__svcaller
    File genome_resources__rnaseq__transcripts_mask
    File genome_resources__variation__train_1000g
    String config__algorithm__coverage_interval
    File genome_resources__rnaseq__gene_bed
    File genome_resources__variation__train_hapmap
    String rgnames__lb
    File genome_resources__variation__dbnsfp
    String rgnames__rg
    String config__algorithm__realign
    String metadata__batch
    String rgnames__lane
    Float config__algorithm__nomap_split_targets
    File reference__bwa__indexes
    Array[File] reference__genome_context
    Float config__algorithm__nomap_split_size
    Array[File] files
    String genome_resources__srnaseq__srna_transcripts
    String config__algorithm__cwl_reporting
    File reference__snpeff__hg19
    String description
    File config__algorithm__validate_regions
    String config__algorithm__aligner
    File genome_resources__variation__train_omni
    String rgnames__pl
    String genome_build
    String rgnames__pu
    String config__algorithm__recalibrate
    String metadata__phenotype
    File genome_resources__rnaseq__transcripts
    String genome_resources__aliases__human
    Array[String] config__algorithm__tools_off
    File genome_resources__variation__dbsnp
    String config__algorithm__mark_duplicates
    File genome_resources__variation__ancestral
    String vrn_file
    Float genome_resources__version
    File genome_resources__variation__cosmic
    String genome_resources__srnaseq__mirbase
    Array[String] config__algorithm__qc
    String analysis
    String rgnames__sample
    Array[String] config__algorithm__tools_on
    File config__algorithm__variant_regions
    String genome_resources__aliases__ensembl
    File reference__snap__indexes
    File genome_resources__variation__train_indels
    String genome_resources__aliases__snpeff
    Array[String] config__algorithm__archive
    ...
    call multiqc_summary {
        input: genome_build=genome_build, 
          summary__qc__samtools=pipeline_summary.summary__qc__samtools, 
...
task postprocess_alignment {
    ...
    command {
        ...
        sentinel-outputs=${default='["config__algorithm__coverage_interval","config__algorithm__variant_regions","config__algorithm__variant_regions_merged","config__algorithm__variant_regions_orig","config__algorithm__seq2c_bed_ready","regions__callable","regions__sample_callable","regions__nblock","regions__highdepth"]' sentinel-outputs} \
        align_bam=${align_bam} \
...
task prep_samples {
    ...
    command {
        ...
        sentinel-parallel=${default='multi-parallel' sentinel-parallel} \
        sentinel-outputs=${default='["config__algorithm__variant_regions","config__algorithm__variant_regions_merged","config__algorithm__variant_regions_orig","config__algorithm__seq2c_bed_ready"]' sentinel-outputs} \
        config__algorithm__variant_regions=${config__algorithm__variant_regions} \
        reference__fasta__base=${reference__fasta__base} \
        description=${description}
    }
