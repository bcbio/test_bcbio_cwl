...
- id: reference__snpeff__hg19
  type:
    items: File
    type: array
- id: genome_resources__variation__editing
  type:
    items:
    - 'null'
    - string
